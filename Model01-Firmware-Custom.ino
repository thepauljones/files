...
KEYMAPS(
  ...
  (___,          Key_1, Key_2, Key_3, Key_4, Key_5, Key_LEDEffectNext,
   ...
   LCTRL(LSHIFT(LGUI(Key_4))),  Key_6, Key_7, Key_8,     Key_9,         Key_0,         Key_Minus,
   Key_Enter,     Key_Y, Key_U, Key_I,     Key_O,         Key_P,         Key_Equals,
                  Key_H, Key_J, Key_K,     Key_L,         Key_Semicolon, Key_Quote,
   LSHIFT(Key_Backtick),  Key_N, Key_M, Key_Comma, Key_Period,    Key_Slash,     Key_RightShift,
   Key_RightShift, Key_Enter, Key_Spacebar, Key_LeftAlt,
   ShiftToLayer(FUNCTION)),
...
#error "No default keymap defined. You should make sure that you have a line like '#define PRIMARY_KEYMAP_QWERTY' in your sketch"
  ...
  (___,      Key_F1,           Key_F2,      Key_F3,     Key_F4,        Key_F5,           Key_CapsLock,
   ...
   Consumer_ScanPreviousTrack, Key_F6,                 Key_F7,                   Key_F8,                   LSHIFT(Key_9),          LSHIFT(Key_0),          ShiftToLayer(NUMPAD),
